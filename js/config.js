      ...
      memories: {
        ...
        a: {
          ...
          lines: [
            "岩倉把兩件公主裙掛在自己身前，比了半天。",
            "「礦坑那些人老問我什麼時候嫁人。煩死了。」",
            "她壓低聲音：「我喜歡的是女孩子。你是我信得過的朋友，我才跟你說。」",
            "「倒不是怕他們。只是解釋起來很麻煩，還不如一起挖礦。」",
            "她把其中一件塞到你手上：「好了，祕密講完了。現在認真幫我挑。」",
            "「不准又說兩件都好看。那是偷懶。」"
          ]
        },
        b: {
          ...
          item: "與赤井的珍貴回憶",
          lines: [
            "五個弟弟妹妹終於睡著，屋裡突然安靜得不習慣。",
            "赤井收著六個人的碗：「小時候我最怕的就是這種安靜。」",
            "「我進礦坑，是因為總覺得爸媽還在裡面。他們會看著我，不讓我出事。」",
            "他看見你的表情，立刻皺眉：「別同情我。我們過得很好。」",
            "「真想幫忙，明天早點來。最小的那個算術，我教到快翻桌了。」",
            "他笑了一聲：「只能幫這個。其他的，我自己來。」"
          ]
        },
        c: {
          title: "另一枚手裡劍",
          item: "與霧島的珍貴回憶",
          lines: [
            "神社後方的小木箱裡，放著一枚削得歪歪斜斜的木製手裡劍。",
            "「十一歲以前做的。」霧島拍掉上面的灰。",
            "「父親走後，我去下坑。弟弟還小，總得有人把飯帶回家。」",
            "「另一枚在我弟那裡。他到現在還留著。」",
            "他把木製手裡劍交給你：「想學的話，下次教你。」",
            "霧島笑了一下：「先說好。敢笑它削得醜，就加練。」"
          ]
        }
      },
        ...
        b: {
          ...
          hot: {
            ...
            during: [
              ...
              "「哥！」最小的那個還沒你膝蓋高",
              "他熟練地把飯分成六份，自己那份最少",
              "「我爸媽走得早，兩個都是在坑裡。」他一邊餵最小的一邊說，語氣跟平常完全不一樣",
              "牆上貼著小學的獎狀，名字不是他的",
              "「我沒唸完書。」他笑了一下，「他們可以就好。」",
