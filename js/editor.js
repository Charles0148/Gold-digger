...
(function () {
  ...
  function tabTexts(body) {
    const T = draft.texts;
    const single = [["omenTag", "地鳴標籤"], ["omenEnter", "地鳴開始"], ["chanceLose", "地鳴平息"], ["chanceCollapse", "演出失敗：坍塌"], ["chanceWin", "演出成功"], ["revive", "復活"], ["directWin", "金礦直擊"], ["stock", "礦脈延伸告知"], ["atHighTag", "共鳴標籤"], ["atHighTagDeep", "深層共鳴標籤"], ["atHighEnterDeep", "深層共鳴開始"], ["atHighEnter", "共鳴開始"], ["atHighHint", "共鳴中暗示"], ["atHighEnd", "共鳴結束"], ["upgrade", "礦脈變粗告知"], ["bonusChain", "礦脈延伸揭曉"], ["bonusChainSurprise", "最後一揮才揭曉"], ["bonusEnd", "礦脈結束"], ["koukakuHint", "高確暗示"], ["hintSfx", "違和感：音效"], ["hintDrip", "違和感：水滴"], ["hintGlow", "違和感：紋路"], ["hintTap", "違和感：點擊提示"], ["toolDrop", "工具掉落"], ["toolBreak", "工具損壞"], ["noTool", "沒有工具"], ["tap", "點擊提示"]];
    body.innerHTML = `
  ...
  const LABEL = {
    ...
    length: "長度(揮)", cont: "延伸（連莊）抽選", atHigh: "礦層共鳴（AT中的高確）", boost: "第5隻以後（深層共鳴）", enterEpic: "紫礦→進入共鳴", enterLegend: "金礦→進入共鳴", contEpic: "共鳴中紫礦→延伸", contLegend: "共鳴中金礦→延伸", boostAfter: "第幾隻起加強", low: "第1～4隻", high: "加強後", add: "挖到稀有礦加成", upgrade: "升格率", RBtoBB: "RB→BB", BBtoSBB: "BB→SBB", announceRate: "當下告知機率",
